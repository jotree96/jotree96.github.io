...
Allerdings hat sich ein MacBook in mein Sortiment eingeschlichen und auch von diesem will gedruckt werden.

Das Problem: ```brlaser``` ist unter MacOS nicht verfügbar und muss selbst gebaut werden:
...
```
*PPD-Adobe: "4.3"
*%%%% PPD file for MFC-7240 with CUPS.
*%%%% Created by the CUPS PPD Compiler CUPS v2.4.1.
*FormatVersion: "4.3"
*FileVersion: "6"
...
*ModelName: "Brother MFC-7240"
*ShortNickName: "Brother MFC-7240"
*NickName: "Brother MFC-7240, using brlaser v6"
...
*1284DeviceID: "MFG:Brother;MFG:Brother;CMD:PJL,HBP;MDL:MFC-7240;CLS:PRINTER;CID:Brother Laser Type1;"
*cupsVersion: 2.4
*cupsModelNumber: 0
...
*% End of br7240.ppd, 07990 bytes.
```

Nun kannst du via CUPS deinen Drucker hinzufügen.